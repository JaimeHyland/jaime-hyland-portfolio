      ...
      <CollapsibleSection id="independent" title={t("section2.title")}>
        ...
        <ul className="space-y-4">
          <li>
            ...
            <p>
              {t.rich("section2.projects.portfolio.desc1", {
                bold: (chunks) => <strong>{chunks}</strong>
              })}
            </p>
            <p>
              {t.rich("section2.projects.portfolio.desc2", {
                bold: (chunks) => <strong>{chunks}</strong>
              })}
            </p>
            ...
            <p>
              {t.rich("section2.projects.portfolio.desc3", {
                bold: (chunks) => <strong>{chunks}</strong>
              })}
            </p>
            <p>
      ...
      <CollapsibleSection id="hackathons" title={t("section3.title")}>
        ...
        <ul className="space-y-6">
          ...
          <li className="flex justify-between items-center">
            <div>
              <strong>{t("section3.projects.co2nscious.name")}</strong>
              <br />
              <em>{t("section3.projects.co2nscious.desc")}</em>
              <br />
